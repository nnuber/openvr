...
// force definition of limit macros on POSIX
...
enum EVRSubmitFlags
{
	...
	// Do not use, see vrcompositorsharedstate.h
...
enum EVRApplicationType
{
	...
	VRApplication_RoomView = 13,	// reserved for the XRService process
...
enum EVRInitError
{
	...
	VRInitError_Compoistor_CreateInverseDistortUVs								= 494,
	VRInitError_Compoistor_CreateBackbufferDepth								= 495,
